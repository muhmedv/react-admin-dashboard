...
const PRODUCT_DATA = [
  { id: 1, name: "Wirless Earbuds", category: "Electronics", price: 59.99, stock: 143, sales: 1200 },
  { id: 2, name: "Leather Wallet", category: "Accessorise", price: 39.99, stock: 89, sales: 800 },
  { id: 3, name: "Smart Watch", category: "Electronics", price: 199.99, stock: 56, sales: 650 },
  { id: 4, name: "Yoga Mat", category: "Fitness", price: 29.99, stock: 210, sales: 950 },
  { id: 5, name: "Coffe Maker", category: "Home", price: 79.99, stock: 78, sales: 720 },
];
        ...
        <table className="min-w-full divide-y divide-gray-700">
          ...
          <tbody className="divide-y divide-gray-700">
            {filteredProducts.map(product => (
              ...
              >
                <td
                className="px-6 py-4 whitespace-nowrap text-sm text-gray-100 flex gap-2 items-center"
                >
                  {product.name}
                </td>
